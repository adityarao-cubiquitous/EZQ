...
- MVP QR generation writes PNG/SVG assets under `assets/qr/{restaurantId}/{branchSlug}`, refreshes `assets/qr/manifest.json` and `assets/qr/index.html`, and saves local QR metadata back to the branch document.
